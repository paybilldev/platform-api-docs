      ...
      <div className="container">
            ...
            {logo && (
              <>
                ...
                <div className="footer__socials" style={{ marginTop: '1rem', display: 'flex', gap: '1rem' }}>
                  <a href="https://github.com/paybilldev" target="_blank" rel="noopener noreferrer">
                    <ThemedImage
                      sources={{
                  ...
                  <a href="https://x.com/paybilldev" target="_blank" rel="noopener noreferrer">
                    <ThemedImage
                      sources={{
        ...
        <div className="footer__bottom" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <div className="footer__policies" style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
            <Link to="https://www.paybill.dev/legal/privacy" style={{ color: '#606770' }}>Privacy policy</Link>
            <span></span><span></span><span></span>
            <Link to="https://www.paybill.dev/legal/terms" style={{ color: '#606770' }}>Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
