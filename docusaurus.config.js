...
module.exports = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: 'support_us',
      content:
        'Follow our repositories on <a target="_blank" rel="noopener noreferrer" href="https://github.com/paybilldev">GitHub</a> to stay updated with new features and contribute to our platform!',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://www.paybill.dev/dashboard',
          position: 'right',
          label: 'Sign in',
          className: 'navbar-signin',
    ...
    footer: {
      ...
      links: [
        {
          ...
          items: [
            ...
            { label: 'GitHub', href: 'https://github.com/paybilldev' }
          ],
        },
        {
          title: 'Contact us',
      ...
      (function () {
          ...
          function appendTrackingToLinks() {
              ...
              const allowedDomains = ['paybill.dev'];
              links.forEach(link => {
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
            ...
            editUrl: 'https://github.com/paybilldev/platform-api-docs/blob/develop/',
